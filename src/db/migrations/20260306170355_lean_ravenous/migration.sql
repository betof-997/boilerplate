...
ALTER TABLE `client` RENAME COLUMN `user_id` TO `userId`;--> statement-breakpoint
ALTER TABLE `client` RENAME COLUMN `created_at` TO `createdAt`;--> statement-breakpoint
ALTER TABLE `client` RENAME COLUMN `updated_at` TO `updatedAt`;--> statement-breakpoint
ALTER TABLE `organization` RENAME COLUMN `created_at` TO `createdAt`;--> statement-breakpoint
ALTER TABLE `organization` RENAME COLUMN `updated_at` TO `updatedAt`;--> statement-breakpoint
ALTER TABLE `product` RENAME COLUMN `user_id` TO `userId`;--> statement-breakpoint
ALTER TABLE `product` RENAME COLUMN `created_at` TO `createdAt`;--> statement-breakpoint
ALTER TABLE `product` RENAME COLUMN `updated_at` TO `updatedAt`;--> statement-breakpoint
